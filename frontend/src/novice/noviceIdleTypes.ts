...
export const NOVICE_LESSONS: readonly NoviceLessonDef[] = [
  ...
  },
  {
    ...
    pathExactAny: ['/dojo', '/dojo/issuance', '/issue-verify'],
    label: 'Issue demo Menkyo (issuance)',
    tip: 'Tehon の Menkyo — browser-only demo VC from /dojo or combined Issue & verify.',
  },
  {
    id: 'visit_shinbi',
...
export function routeInsightBonus(pathname: string): number {
  ...
  if (pathname === '/dojo' || pathname.startsWith('/dojo/')) return 1.24
