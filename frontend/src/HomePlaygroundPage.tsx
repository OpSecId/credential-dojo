...
/** Dev/test page: former full home layout (CTA grid, lexicon strip, playground panels). */
export default function HomePlaygroundPage() {
  ...
  return (
    ...
    >
      ...
      <div className="dojo">
        <p className="dojo__testBanner" role="note">
          Test layout — full home playground.{' '}
          <Link className="dojo__calmCollapse" to="/">
            Return to calm home
          </Link>
        </p>
        ...
        <div className="dojo__introBand">
          <header className="dojo__header">
            ...
            <p className="dojo__lede">
              Credential operations for <strong>W3C Verifiable Credentials</strong>. Dojo names (Tehon, Menkyo,
              Enbu, …) are metaphors for real artifacts and steps in this UI.
            </p>
            {!ninjaProfile ? (
              <p className="dojo__heroCtas" aria-label="Get started">
                <Link
                  ...
                  to="/journey"
                  title="Journey — milestones, lexicon, and learning pathways"
                >
                  Start journey
                </Link>
                <Link
            ...
            {!ninjaProfile ? (
              ...
              >
                ...
                <p className="dojo__lexPrimer-body">
                  The platform uses a small set of metaphors. The Lexicon maps them to W3C VC concepts so the
                  rest of the UI reads clearly.
                </p>
        ...
        <nav className="dojo__ctaBand" aria-label="Quick tools">
          ...
          <Link className="dojo__ctaTile" to="/expedition" title="Story adventure across the full credential flow">
          ...
          <Link className="dojo__ctaTile" to="/tejun-viewer" title="React Flow map of the expedition runbook">
        ...
        <section id="dojo-lexicon" className="dojo__lex dojo__lex--compact" aria-labelledby="lexicon-heading">
          ...
          <div className="dojo__panels">
            ...
            >
              ...
              <p className="dojo__panelBody">
                The platform wallet: hold <strong>Menkyo</strong> (issued credentials), compose an{' '}
                <strong>Enbu</strong> (verifiable presentation) when a verifier asks for proofs, and keep everything
                aligned with issuer <strong>Tehon</strong>, <strong>Katachi</strong>, and <strong>Kata</strong>—without
                leaving the CRMS story.
              </p>

              <div
                className="kinchaku-widget dojo-augmented dojo-augmented--inset"
                data-augmented-ui="tl-clip br-clip border"
              >
                ...
                <div className="dojo__kinchakuPlay">
                  <button
                    ...
                    aria-label={kinchakuCinched ? 'Loosen Kinchaku drawstrings' : 'Cinch Kinchaku drawstrings'}
                  >
                    <svg className="dojo-pouch__svg" viewBox="0 0 88 108" width="88" height="108" aria-hidden>
                      <defs>
                        <linearGradient id={pouchGradId} x1="0%" y1="0%" x2="100%" y2="100%">
                  ...
                  <p className="dojo__hint">
                    {kinchakuCinched ? 'Cinched tight — tap to loosen.' : 'Tap the pouch to cinch the drawstrings.'}
                  </p>
                </div>
            ...
            <section className="dojo__panel dojo__panel--kata" aria-labelledby="kata-heading">
              ...
              <p className="dojo__panelBody">
                The metaphor for <strong>cryptosuites</strong> (and related proof / signature suites): a fixed{' '}
                <em>kata</em>—the standardized pattern issuers and verifiers run when creating or checking proofs for
                W3C VCs.
              </p>
            ...
            >
              ...
              {apiMessage ? (
                <>
                  ...
                  {apiStandardsFocus ? <p className="dojo__panelNote">{apiStandardsFocus}</p> : null}
                </>
              ) : apiError ? (
